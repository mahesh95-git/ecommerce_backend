...
const {addProductToCart, getAllcartItem, detletCartItem, updateProductQuantity}=require('../controller/cart');
...
router.route('/cart/deleteItme/:id').delete(isAuthenticatedUser,detletCartItem)
